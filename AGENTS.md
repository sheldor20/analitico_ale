...
- O acompanhamento de cooperativas e PAs deve mostrar todas as unidades filtradas na mesma tela, sem rolagem vertical interna (pedido atualizado); usar a rolagem natural da página e permitir rolagem horizontal quando necessária.
