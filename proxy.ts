...
import { getPublicAuthConfig, isPublicRequest, securityHeaders } from '@/lib/auth-policy.mjs';
...
export async function proxy(request: NextRequest) {
  ...
  if (isPublicRequest(request.nextUrl.pathname, request.method)) return finish(response);
