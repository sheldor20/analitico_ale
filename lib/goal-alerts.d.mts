...
export type GoalAlert = { key: string; year: number; month: number; entity: RegistryEntity; metric: Metric; metricLabel: string; target: number; actual: number; attainment: number; cutoff: string; cutoffMin: string };
