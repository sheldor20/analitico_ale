...
declare target text;
begin
  foreach target in array array['commercial_imports','commercial_actions','commercial_workspaces','commercial_entity_contacts','commercial_communication_drafts'] loop
