...
export function PaTable({ dataset, filters, onSelect, onShare, expanded = false, onToggle }: { dataset: Dataset; filters: ScenarioFilters; onSelect?: (row: any) => void; onShare?: () => void; expanded?: boolean; onToggle: () => void }) {
